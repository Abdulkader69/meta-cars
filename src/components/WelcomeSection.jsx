    ...
    <div className="welcome-area mb-[5.5rem]">
      <div className="top">
        <div className="title mb-7">
          <h2 className="font-brandon text-white text-[2.5rem] lg:text-[4rem] leading-[1.6] pl-4 md:pl-0">
            Welcome to the
            <br />
      ...
      <div className="row flex flex-wrap">
        <div className="w-full md:w-[60%] bg-black bg-opacity-40 py-5 pl-4 md:pl-8 pr-4 mb-11 md:mb-0">
