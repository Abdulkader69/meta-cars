...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-siteContainer mx-auto px-4 flex items-center justify-center">
        <ul className="flex items-center justify-center">
          <li className="mx-10">
            <Link href="/">
              <a
                className={`text-sm sm:text-[1.6rem] font-futura ${
          ...
          <li className="mx-10 header-logo">
            <Link href="/">
              <a
                className={`text-sm sm:text-[1.6rem] font-futura ${
                  router.pathname == '/' ? 'text-[#47B1FF]' : 'text-[#D6D6D6]'
